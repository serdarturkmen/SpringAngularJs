...
import com.example.thymeleaf.exceptions.SupportInfoException;
...
/**
 * Performs the global exception handling
...
public class GlobalExceptionHandlingControllerAdvice {
	...
	public ModelAndView nullEx(HttpServletRequest request, HttpServletResponse response, Exception exception)  throws IOException, ServletException {
